...
HXDLIN( 229)		switch((int)(h->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 229)				int n = h->_hx_getInt(0);
HXLINE( 230)				return n;
            			}
            			break;
            			case (int)1: {
HXDLIN( 229)				 ::haxe::zip::Huffman a = h->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN( 229)				 ::haxe::zip::Huffman b = h->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXLINE( 231)				 ::haxe::zip::Huffman _hx_tmp;
...
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			...
            			break;
            			case (int)2: {
HXDLIN( 229)				int n1 = h->_hx_getInt(0);
HXDLIN( 229)				::Array< ::Dynamic> tbl = h->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 232)				return this->applyHuffman(tbl->__get(this->getBits(n1)).StaticCast<  ::haxe::zip::Huffman >());
            			}
            			break;
            		}
HXLINE( 229)		return 0;
