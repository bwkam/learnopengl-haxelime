...
HXDLIN( 352)						int elementSize = _this1->bytesPerElement;
HXDLIN( 352)						if ((view->type == _this1->type)) {
HXLINE( 352)							int srcLength1 = srcData->length;
HXDLIN( 352)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 352)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 352)							_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 352)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 352)						_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 352)						_this1->byteOffset = 0;
HXDLIN( 352)						_this1->length = srcLength;
...
HXDLIN( 352)							if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 352)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 352)							int bufferByteLength = buffer->length;
HXDLIN( 352)							int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 352)								if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 352)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 352)								newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 352)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 352)								if ((newRange > bufferByteLength)) {
HXLINE( 352)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 352)							_this2->buffer = buffer;
HXDLIN( 352)							_this2->byteOffset = in_byteOffset;
HXDLIN( 352)							_this2->byteLength = newByteLength;
HXDLIN( 352)							_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN( 382)			::cpp::VirtualArray array1 = null();
...
HXLINE( 382)				if (::hx::IsNotNull( array1 )) {
HXLINE( 382)					 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 382)					_this3->byteOffset = 0;
HXDLIN( 382)					_this3->length = array1->get_length();
HXDLIN( 382)					_this3->byteLength = (_this3->length * _this3->bytesPerElement);
HXDLIN( 382)					_this3->buffer = ::haxe::io::Bytes_obj::alloc(_this3->byteLength);
HXDLIN( 382)					_this3->copyFromArray(array1,null());
HXDLIN( 382)					this2 = _this3;
            				}
            				else {
...
HXDLIN( 382)						int elementSize2 = _this4->bytesPerElement;
HXDLIN( 382)						if ((view1->type == _this4->type)) {
HXLINE( 382)							int srcLength3 = srcData1->length;
HXDLIN( 382)							int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 382)							_this4->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 382)							_this4->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            						}
            						else {
HXLINE( 382)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 382)						_this4->byteLength = (_this4->bytesPerElement * srcLength2);
HXDLIN( 382)						_this4->byteOffset = 0;
HXDLIN( 382)						_this4->length = srcLength2;
...
HXDLIN( 382)							if ((::hx::Mod(in_byteOffset1,_this5->bytesPerElement) != 0)) {
HXLINE( 382)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 382)							int bufferByteLength1 = buffer2->length;
HXDLIN( 382)							int elementSize3 = _this5->bytesPerElement;
...
HXDLIN( 382)								if ((::hx::Mod(bufferByteLength1,_this5->bytesPerElement) != 0)) {
HXLINE( 382)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 382)								newByteLength1 = (( (int)(len1) ) * _this5->bytesPerElement);
HXDLIN( 382)								int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 382)								if ((newRange1 > bufferByteLength1)) {
HXLINE( 382)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 382)							_this5->buffer = buffer2;
HXDLIN( 382)							_this5->byteOffset = in_byteOffset1;
HXDLIN( 382)							_this5->byteLength = newByteLength1;
HXDLIN( 382)							_this5->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this5->bytesPerElement) )));
