...
HXDLIN(  90)					int elementSize = _this1->bytesPerElement;
HXDLIN(  90)					if ((view->type == _this1->type)) {
HXLINE(  90)						int srcLength1 = srcData->length;
HXDLIN(  90)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(  90)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  90)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE(  90)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN(  90)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(  90)					_this1->byteOffset = 0;
HXDLIN(  90)					_this1->length = srcLength;
...
HXDLIN(  90)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(  90)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN(  90)						int bufferByteLength = buffer->length;
HXDLIN(  90)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(  90)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(  90)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE(  90)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(  90)							int newRange = (in_byteOffset + newByteLength);
HXDLIN(  90)							if ((newRange > bufferByteLength)) {
HXLINE(  90)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN(  90)						_this2->buffer = buffer;
HXDLIN(  90)						_this2->byteOffset = in_byteOffset;
HXDLIN(  90)						_this2->byteLength = newByteLength;
HXDLIN(  90)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN( 127)					int elementSize = _this1->bytesPerElement;
HXDLIN( 127)					if ((view->type == _this1->type)) {
HXLINE( 127)						int srcLength1 = srcData->length;
HXDLIN( 127)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 127)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 127)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE( 127)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN( 127)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 127)					_this1->byteOffset = 0;
HXDLIN( 127)					_this1->length = srcLength;
...
HXDLIN( 127)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 127)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 127)						int bufferByteLength = buffer->length;
HXDLIN( 127)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 127)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 127)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE( 127)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 127)							int newRange = (in_byteOffset + newByteLength);
HXDLIN( 127)							if ((newRange > bufferByteLength)) {
HXLINE( 127)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN( 127)						_this2->buffer = buffer;
HXDLIN( 127)						_this2->byteOffset = in_byteOffset;
HXDLIN( 127)						_this2->byteLength = newByteLength;
HXDLIN( 127)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN( 176)					int elementSize = _this1->bytesPerElement;
HXDLIN( 176)					if ((view->type == _this1->type)) {
HXLINE( 176)						int srcLength1 = srcData->length;
HXDLIN( 176)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 176)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 176)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE( 176)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN( 176)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 176)					_this1->byteOffset = 0;
HXDLIN( 176)					_this1->length = srcLength;
...
HXDLIN( 176)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 176)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 176)						int bufferByteLength = buffer->length;
HXDLIN( 176)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 176)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 176)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE( 176)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 176)							int newRange = (in_byteOffset + newByteLength);
HXDLIN( 176)							if ((newRange > bufferByteLength)) {
HXLINE( 176)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN( 176)						_this2->buffer = buffer;
HXDLIN( 176)						_this2->byteOffset = in_byteOffset;
HXDLIN( 176)						_this2->byteLength = newByteLength;
HXDLIN( 176)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
