...
HXDLIN(  33)					int elementSize = _this1->bytesPerElement;
HXDLIN(  33)					if ((view->type == _this1->type)) {
HXLINE(  33)						int srcLength1 = srcData->length;
HXDLIN(  33)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(  33)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  33)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE(  33)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN(  33)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(  33)					_this1->byteOffset = 0;
HXDLIN(  33)					_this1->length = srcLength;
...
HXDLIN(  33)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(  33)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN(  33)						int bufferByteLength = buffer1->length;
HXDLIN(  33)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(  33)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(  33)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE(  33)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(  33)							int newRange = (in_byteOffset + newByteLength);
HXDLIN(  33)							if ((newRange > bufferByteLength)) {
HXLINE(  33)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN(  33)						_this2->buffer = buffer1;
HXDLIN(  33)						_this2->byteOffset = in_byteOffset;
HXDLIN(  33)						_this2->byteLength = newByteLength;
HXDLIN(  33)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN(  58)					int elementSize = _this1->bytesPerElement;
HXDLIN(  58)					if ((view->type == _this1->type)) {
HXLINE(  58)						int srcLength1 = srcData->length;
HXDLIN(  58)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(  58)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  58)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE(  58)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN(  58)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(  58)					_this1->byteOffset = 0;
HXDLIN(  58)					_this1->length = srcLength;
...
HXDLIN(  58)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(  58)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN(  58)						int bufferByteLength = buffer1->length;
HXDLIN(  58)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(  58)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(  58)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE(  58)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(  58)							int newRange = (in_byteOffset + newByteLength);
HXDLIN(  58)							if ((newRange > bufferByteLength)) {
HXLINE(  58)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN(  58)						_this2->buffer = buffer1;
HXDLIN(  58)						_this2->byteOffset = in_byteOffset;
HXDLIN(  58)						_this2->byteLength = newByteLength;
HXDLIN(  58)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
