...
HXDLIN( 177)						int elementSize = _this1->bytesPerElement;
HXDLIN( 177)						if ((view->type == _this1->type)) {
HXLINE( 177)							int srcLength1 = srcData->length;
HXDLIN( 177)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 177)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 177)							_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 177)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 177)						_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 177)						_this1->byteOffset = 0;
HXDLIN( 177)						_this1->length = srcLength;
...
HXDLIN( 177)							if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 177)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 177)							int bufferByteLength = bytes->length;
HXDLIN( 177)							int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 177)								if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 177)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 177)								newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 177)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 177)								if ((newRange > bufferByteLength)) {
HXLINE( 177)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 177)							_this2->buffer = bytes;
HXDLIN( 177)							_this2->byteOffset = in_byteOffset;
HXDLIN( 177)							_this2->byteLength = newByteLength;
HXDLIN( 177)							_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
