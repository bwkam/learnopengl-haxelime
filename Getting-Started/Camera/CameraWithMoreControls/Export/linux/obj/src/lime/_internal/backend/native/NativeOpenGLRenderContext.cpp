...
HXDLIN(1830)							int elementSize = _this1->bytesPerElement;
HXDLIN(1830)							if ((view4->type == _this1->type)) {
HXLINE(1830)								int srcLength1 = srcData->length;
HXDLIN(1830)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1830)								_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1830)								_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1830)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN(1830)							_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(1830)							_this1->byteOffset = 0;
HXDLIN(1830)							_this1->length = srcLength;
...
HXDLIN(1830)								if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(1830)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1830)								int bufferByteLength = buffer4->length;
HXDLIN(1830)								int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(1830)									if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(1830)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE(1830)									newByteLength = (( (int)(len4) ) * _this2->bytesPerElement);
HXDLIN(1830)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1830)									if ((newRange > bufferByteLength)) {
HXLINE(1830)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN(1830)								_this2->buffer = buffer4;
HXDLIN(1830)								_this2->byteOffset = in_byteOffset;
HXDLIN(1830)								_this2->byteLength = newByteLength;
HXDLIN(1830)								_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN(2312)										int elementSize = _this1->bytesPerElement;
HXDLIN(2312)										if ((view->type == _this1->type)) {
HXLINE(2312)											int srcLength1 = srcData->length;
HXDLIN(2312)											int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(2312)											_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(2312)											_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            										}
            										else {
HXLINE(2312)											HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            										}
HXDLIN(2312)										_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(2312)										_this1->byteOffset = 0;
HXDLIN(2312)										_this1->length = srcLength;
...
HXDLIN(2312)											if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(2312)												HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            											}
HXDLIN(2312)											int bufferByteLength = buffer->length;
HXDLIN(2312)											int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(2312)												if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(2312)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
...
HXLINE(2312)												newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(2312)												int newRange = (in_byteOffset + newByteLength);
HXDLIN(2312)												if ((newRange > bufferByteLength)) {
HXLINE(2312)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
            											}
HXDLIN(2312)											_this2->buffer = buffer;
HXDLIN(2312)											_this2->byteOffset = in_byteOffset;
HXDLIN(2312)											_this2->byteLength = newByteLength;
HXDLIN(2312)											_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN(2318)								::cpp::VirtualArray array1 = null();
...
HXLINE(2318)									if (::hx::IsNotNull( array1 )) {
HXLINE(2318)										 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(2318)										_this3->byteOffset = 0;
HXDLIN(2318)										_this3->length = array1->get_length();
HXDLIN(2318)										_this3->byteLength = (_this3->length * _this3->bytesPerElement);
HXDLIN(2318)										_this3->buffer = ::haxe::io::Bytes_obj::alloc(_this3->byteLength);
HXDLIN(2318)										_this3->copyFromArray(array1,null());
HXDLIN(2318)										this2 = _this3;
            									}
            									else {
...
HXDLIN(2318)											int elementSize2 = _this4->bytesPerElement;
HXDLIN(2318)											if ((view1->type == _this4->type)) {
HXLINE(2318)												int srcLength3 = srcData1->length;
HXDLIN(2318)												int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN(2318)												_this4->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN(2318)												_this4->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            											}
            											else {
HXLINE(2318)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN(2318)											_this4->byteLength = (_this4->bytesPerElement * srcLength2);
HXDLIN(2318)											_this4->byteOffset = 0;
HXDLIN(2318)											_this4->length = srcLength2;
...
HXDLIN(2318)												if ((::hx::Mod(in_byteOffset1,_this5->bytesPerElement) != 0)) {
HXLINE(2318)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN(2318)												int bufferByteLength1 = buffer1->length;
HXDLIN(2318)												int elementSize3 = _this5->bytesPerElement;
...
HXDLIN(2318)													if ((::hx::Mod(bufferByteLength1,_this5->bytesPerElement) != 0)) {
HXLINE(2318)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE(2318)													newByteLength1 = (( (int)(len1) ) * _this5->bytesPerElement);
HXDLIN(2318)													int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN(2318)													if ((newRange1 > bufferByteLength1)) {
HXLINE(2318)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN(2318)												_this5->buffer = buffer1;
HXDLIN(2318)												_this5->byteOffset = in_byteOffset1;
HXDLIN(2318)												_this5->byteLength = newByteLength1;
HXDLIN(2318)												_this5->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this5->bytesPerElement) )));
