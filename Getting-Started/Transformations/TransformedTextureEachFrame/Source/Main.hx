...
class Main extends Application {
	...
	function initialize(gl:WebGL2RenderContext):Void {
		...
		trans = new Matrix4(new Float32Array(transMat));
		trans.appendTranslation(0.5, -0.5, 0.0);
...
";
		...
		gl.uniformMatrix4fv(gl.getUniformLocation(program, "transform"), false, trans);
	}
	...
	public override function render(context:RenderContext):Void {
		switch (context.type) {
			case OPENGL, OPENGLES, WEBGL:
				...
				trans.appendRotation(Timer.stamp(), new Vector4(0.0, 0.0, 1.0, 1.0));
