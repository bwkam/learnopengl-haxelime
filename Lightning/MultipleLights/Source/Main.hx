...
class Main extends Application {
	...
	var pointLightsPositions:Array<Array<Float>>;
	...
	function initialize(gl:WebGLRenderContext):Void {
		...
		pointLightsPositions = [[0.7, 0.2, 2.0], [2.3, -3.3, -4.0], [-4.0, 2.0, -12.0], [0.0, 0.0, -3.0]];
	...
	public override function render(context:RenderContext):Void {
		...
		for (i in 0...10) {
			...
			cube.render({
				...
				light: {
					...
					pointLights: [
						{
							position: pointLightsPositions[0],
							ambient: [0.05, 0.05, 0.05],
							diffuse: [0.8, 0.8, 0.8],
						...
						{
							position: pointLightsPositions[1],
							ambient: [0.05, 0.05, 0.05],
							diffuse: [0.8, 0.8, 0.8],
							specular: [1.0, 1.0, 1.0],
							constant: 1.0,
						...
						{
							position: pointLightsPositions[2],
							ambient: [0.05, 0.05, 0.05],
							diffuse: [0.8, 0.8, 0.8],
							specular: [1.0, 1.0, 1.0],
							constant: 1.0,
						...
						{
							position: pointLightsPositions[3],
							ambient: [0.05, 0.05, 0.05],
							diffuse: [0.8, 0.8, 0.8],
							specular: [1.0, 1.0, 1.0],
							constant: 1.0,
					...
					spotLight: {
						position: MatrixUtils.vecToArray(Camera.pos),
						direction: MatrixUtils.vecToArray(Camera.front),
						ambient: [0.0, 0.0, 0.0],
						diffuse: [1.0, 1.0, 1.0],
						specular: [1.0, 1.0, 1.0],
						constant: 1.0,
		...
		for (pos in pointLightsPositions) {
			model = new Matrix4();
			model.identity();
			model.appendTranslation(pos[0], pos[1], pos[2]);
