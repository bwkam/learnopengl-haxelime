...
typedef ProgramParameters = {
	...
	**/
	@:optional var lightPos:Array<Float>;

	/**
		Camera position
	**/
	@:optional var viewPos:Array<Float>;

	/**
		Material struct
	**/
	@:optional var material:Material;

	/**
		Light struct
	**/
	@:optional var light:Light;

	/**
		Diffuse map
	**/
	@:optional var diffuseMap:GLTexture;

	/**
		Specular map
	**/
	@:optional var specularMap:GLTexture;
