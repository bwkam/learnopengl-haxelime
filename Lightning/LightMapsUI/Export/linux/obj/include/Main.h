...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::lime::app::Application_obj
{
	...
	public:
		...
		Float currentFrame;
		Float lastFrame;
		 ::lime::utils::ArrayBufferView verticesData;
		 ::SimpleCubeProgram cube;
		 ::LightProgram lightCube;
		::Array< ::Dynamic> cubes;
		...
		void setSliderEvents( ::peote::ui::interactive::UISlider slider);
		::Dynamic setSliderEvents_dyn();
