...
HX_LOCAL_STACK_FRAME(_hx_pos_1af32ff740468f4b_204_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/share/haxe/std/haxe/io/BytesBuffer.hx",204,0x054745ce)
namespace haxe{
namespace io{
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_1af32ff740468f4b_204_getBytes)
HXLINE( 222)		 ::haxe::io::Bytes bytes =  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,this->b->length,this->b);
HXLINE( 224)		this->b = null();
HXLINE( 225)		return bytes;
            	}
