...
HXLINE(  36)				return 0;
            			...
            			break;
            			case (int)1: {
HXDLIN(  35)				 ::haxe::zip::Huffman a = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  35)				 ::haxe::zip::Huffman b = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
...
HXDLIN(  41)				return (1 + _hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE(  37)				HX_STACK_DO_THROW(HX_("assert",c6,46,03,4c));
            			}
            			break;
            		}
HXLINE(  35)		return 0;
...
HXLINE(  50)				 ::haxe::zip::Huffman a = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  50)				 ::haxe::zip::Huffman b = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXLINE(  51)				 ::haxe::zip::Huffman _hx_tmp = this->treeCompress(a);
...
HXDLIN(  63)			 ::haxe::zip::Huffman a = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  63)			 ::haxe::zip::Huffman b = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXLINE(  65)			if ((d > 0)) {
