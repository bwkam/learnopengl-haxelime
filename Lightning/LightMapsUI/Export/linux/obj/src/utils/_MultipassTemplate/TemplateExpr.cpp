...
::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpBlock( ::haxe::ds::List l)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpBlock",4c,f4,41,e5),4,1)->_hx_init(0,l);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpExpr( ::Dynamic expr)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpExpr",16,a3,09,41),1,1)->_hx_init(0,expr);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpForeach( ::Dynamic expr, ::utils::_MultipassTemplate::TemplateExpr loop)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpForeach",49,7a,c7,c5),5,2)->_hx_init(0,expr)->_hx_init(1,loop);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpIf( ::Dynamic expr, ::utils::_MultipassTemplate::TemplateExpr eif, ::utils::_MultipassTemplate::TemplateExpr eelse)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpIf",7e,17,8d,34),2,3)->_hx_init(0,expr)->_hx_init(1,eif)->_hx_init(2,eelse);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpMacro(::String name, ::haxe::ds::List params)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpMacro",0b,ef,5b,33),6,2)->_hx_init(0,name)->_hx_init(1,params);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpStr(::String str)
{
	return ::hx::CreateEnum< TemplateExpr_obj >(HX_("OpStr",f0,19,ef,c6),3,1)->_hx_init(0,str);
}

::utils::_MultipassTemplate::TemplateExpr TemplateExpr_obj::OpVar(::String v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("utils._MultipassTemplate.TemplateExpr",bb,2b,64,fa), ::hx::TCanCast< TemplateExpr_obj >,TemplateExpr_obj_sStaticFields,0,
